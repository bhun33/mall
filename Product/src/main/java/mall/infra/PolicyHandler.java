...
public class PolicyHandler{
    ...
    public void wheneverDeliveryCompleted_DecreaseStock(@Payload DeliveryCompleted deliveryCompleted){
    ...
    public void wheneverDeliveryReturned_IncereaseStock(@Payload DeliveryReturned deliveryReturned){

        DeliveryReturned event = deliveryReturned;
        System.out.println("\n\n##### listener IncereaseStock : " + deliveryReturned + "\n\n");


        

        // Sample Logic //
        Inventory.incereaseStock(event);
